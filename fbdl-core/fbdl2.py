...
def generate_user_agent():
    return f"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, Gecko) Chrome/{rr(50, 120)}.0.{rr(1000, 5000)}.{rr(60, 170)} Safari/537.36"
...
def main():
    ...
    else: print("No video URL found for download.")
